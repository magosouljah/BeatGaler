...
{tagRename && (
  ...
  />
      ...
      {showAdd && <AddBeatModal onClose={() => setShowAdd(false)} onAdd={addBeatsAndReview} onCandidateHydrated={hydrateReviewCandidate} existingBeats={beats} />}
