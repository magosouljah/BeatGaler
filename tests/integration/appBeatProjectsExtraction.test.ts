...
describe("Beat project extraction", () => {
  ...
  it("preserves replacement and Backup rules", () => { expect(projects).toContain("isProjectDawExtension(ext)"); expect(projects).toContain("Replace PROJECT ZIP?"); expect(projects).toContain("Replace project file?"); expect(projects).toContain("inspectProjectDropSource(filePath)"); expect(projects).toContain("Backup folders were skipped from"); });
